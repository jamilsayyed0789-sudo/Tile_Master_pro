  ...
  const performDeleteAll = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        let errorMsg = "Failed to delete all tiles";
        try {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white p-6 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full bg-neutral-900/80 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all shadow-inner"
              />
            </div>
      ...
      <ConfirmDialog
        ...
        message="This will permanently remove ALL tiles from your database. This action cannot be undone."
